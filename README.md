...
Open an image, drag the green rectangle (move / resize from edges and corners), save the crop.  
...
| Crop | Drag the green box; corners and edges resize; inside the box moves it |
| Reset | `↺ Нулирай` restores a default rectangle |
